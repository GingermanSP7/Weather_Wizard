package com.demo.weatherwizard.controller.tomorrowAPI;
...
@RequestMapping(value = "/v2/tomorrowAPI")
@RestController
public class TomorrowAPIController {
    private final APIService apiService;

    @Autowired
    public TomorrowAPIController(
            @Qualifier("TomorrowAPIServiceImpl") APIService apiService
    ){
